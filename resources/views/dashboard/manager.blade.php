        ...
        <div class="card stats-card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <p class="text-muted mb-1">Department Employees</p>
                        <h3 class="fw-bold mb-0">{{ $departmentEmployees }}</h3>
                    </div>
    ...
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @else
                <p class="text-muted text-center py-4">No pending leave approvals</p>
                @endif
            </div>
        </div>
    </div>
