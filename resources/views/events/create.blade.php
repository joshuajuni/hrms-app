        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('events.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="affects_attendance" 
                                   name="affects_attendance" value="1" {{ old('affects_attendance', true) ? 'checked' : '' }}>
                            <label class="form-check-label" for="affects_attendance">
                                Affects Attendance (Holiday)
                            </label>
                        </div>
                    </div>
